{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "@app.get(\"/home\")   # Sprecifier le chemin URL et l'action HTTP (GET) de notre API\n",
    "def index():        # Fonction index() sera exécutée chaque fois qu'un utilisateur visitera le chemin URL spécifié par le décorateur @app.get() soit dans ce cas-ci le path \"/home\"\n",
